...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT_all(
      ...
      KC_LSFT, KC_NO,         KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, TG(_GB),        \
      KC_LCTL, KC_LGUI, KC_LALT, KC_NO,                     LT(_FL, KC_SPC),KC_NO,KC_NO,                    KC_RALT, KC_RGUI, KC_RCTL),


  [_FL] = LAYOUT_all(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS, \
      KC_CAPS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_HOME, KC_INS,  KC_TRNS, KC_PSCR, KC_TRNS, KC_TRNS,          KC_DEL,        \
  ...
  [_GB] = LAYOUT_all(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_NO,                     KC_SPC,  KC_NO,   KC_NO,                     KC_RALT, KC_RGUI, KC_RCTL),
  ...
  [_ML] = LAYOUT_all(
      KC_GRV,  KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MPRV, KC_MNXT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,  KC_TRNS, \
      KC_CAPS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_HOME, KC_INS,  KC_TRNS, KC_PSCR, KC_TRNS, KC_TRNS,           KC_TRNS,        \
      KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT,KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_TRNS, KC_TRNS, KC_TRNS,                 \
      KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGDN, KC_END,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        \
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_LCTL, KC_TRNS, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_TRNS),
