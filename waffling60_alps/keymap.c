...
#define _TAB MT(MOD_RALT,KC_TAB)
#define _CAPS MT(MOD_LCTL, KC_ESC)
#define _NUBS MT(MOD_LSFT,KC_NUBS)
#define _SPC LT(1, KC_SPC)
#define _TOGG TG(2)
...
[0] = LAYOUT(
  ...
  _TAB,     KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,       KC_Y,      KC_U,      KC_I,      KC_O,       KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
  _CAPS,    KC_A,     KC_S,     KC_D,     KC_F,     KC_G,       KC_H,      KC_J,      KC_K,      KC_L,       KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,
  KC_LSFT,  _NUBS,    KC_Z,     KC_X,     KC_C,     KC_V,       KC_B,      KC_N,      KC_M,      KC_COMM,    KC_DOT,  KC_SLSH, KC_RSFT, KC_NO,
  KC_LCTL,  KC_LGUI,  KC_LALT,            KC_SPC,               _SPC,                 KC_SPC,                KC_NO,   KC_RALT, KC_RGUI, _TOGG),
// Function layer
[1] = LAYOUT(
...
[2] = LAYOUT(
  ...
  KC_LCTL,  KC_LGUI,  KC_LALT,            KC_SPC,               KC_SPC,               KC_SPC,                KC_NO,   KC_RALT, KC_RGUI, KC_TRNS),
// Gaming function layer
[3] = LAYOUT(
  KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,     KC_F5,     KC_F6,     KC_F7,     KC_F8,     KC_F9,      KC_F10,  KC_F11,   KC_F12,  KC_TRNS, KC_DEL,
  KC_CAPS,  KC_TRNS,  KC_UP,    KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_PGUP,   KC_HOME,   KC_INS,    KC_TRNS,    KC_PSCR, KC_TRNS,  KC_TRNS, KC_TRNS,
  KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_TRNS,   KC_TRNS,   KC_LEFT,   KC_DOWN,   KC_UP,     KC_RIGHT,   KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,
