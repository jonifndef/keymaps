...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT_60_tsangan_hhkb(
        ...
        KC_CAPS, _______, KC_UP,   _______, _______, _______, KC_PGUP, KC_HOME, KC_INS,  _______, KC_PSCR, _______, _______,          _______,
    ...
    [_ML] = LAYOUT_60_tsangan_hhkb(
        RESET,   KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, _______,
